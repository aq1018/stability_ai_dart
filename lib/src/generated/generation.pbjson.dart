...
final $typed_data.Uint8List samplerParametersDescriptor = $convert.base64Decode('');
...
const Request$json = const {
  ...
  '2': const [
    ...
    const {'1': 'weight_method', '3': 9, '4': 1, '5': 14, '6': '.gooseai.WeightMethod', '9': 2, '10': 'weightMethod', '17': true},
    const {'1': 'uc_prompt', '3': 10, '4': 3, '5': 11, '6': '.gooseai.Prompt', '10': 'ucPrompt'},
  ],
  '8': const [
    const {'1': 'params'},
    const {'1': '_conditioner'},
...
final $typed_data.Uint8List requestDescriptor = $convert.base64Decode('');
