...
class Request extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Request', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'gooseai'), createEmptyInstance: create)
    ...
    ..pc<Prompt>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ucPrompt', $pb.PbFieldType.PM, subBuilder: Prompt.create)
    ..hasRequiredFields = false
  ;
  ...
  factory Request({
    ...
    if (ucPrompt != null) {
      _result.ucPrompt.addAll(ucPrompt);
    }
    return _result;
  }
  ...
  @$pb.TagNumber(10)
  $core.List<Prompt> get ucPrompt => $_getList(9);
}
